...
@section('title', __('dashboard.__pluralName__.edit___snake_single_name__'))
                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ __('dashboard.__pluralName__.edit___snake_single_name__') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('dashboard.__pluralName__.edit___snake_single_name__') }}</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="{{ route('admin.__routeName__.update', __singleVariable__) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <!-- You can all alert messages by removing the comment -->
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-label-group form-group">
                                                        <input type="text" id="{{$key}}-string_field" class="form-control" name="string_field[{{$key}}]"
                                                               ...
                                                               value="{{ __singleVariable__->getTranslation("string_field", $key) }}">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-label-group form-group">
                                                        <textarea class="form-control" id="text_field[{{$key}}]"
                                                                  name="text_field[{{$key}}]">{!! __singleVariable__->getTranslation("text_field", $key) !!}</textarea>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-label-group form-group">
                                                    <input type='text' id="float_field" class="form-control"
                                                           name="float_field" placeholder="float_field " value="{{ __singleVariable__->float_field }}"/>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-label-group form-group">
                                                    <select class="form-control select2" name="enum_field">
                                                        <option value="active" @if(__singleVariable__->enum_field == 'agreed' ) selected @endif >تم الموافقة</option>
                                                        <option value="pending" @if(__singleVariable__->enum_field == 'refused' ) selected @endif >تم الرفض</option>
                                                        <option value="block" @if(__singleVariable__->enum_field == 'pending' ) selected @endif >جاري الاطلاع</option>
                                                    </select>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-label-group form-group">
                                                    <input type='text' id="time_field" class="form-control pickatime"
                                                           ...
                                                           value="{{ __singleVariable__->time_field }}"/>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-label-group form-group">
                                                    <input type='text' id="date_field" class="form-control format-picker"
                                                           ...
                                                           value="{{ __singleVariable__->date_field }}"/>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-label-group form-group">
                                                    <div class="custom-control custom-switch switch-lg">
                                                        <input id="boolean_field" type="checkbox" name="boolean_field" @if(__singleVariable__boolean_field == 'on' ) checked @endif class="custom-control-input">
                                                    ...
                                                    <div class="form-label-group">
                                                        <div class="multi-img-result">
                                                            <div class="img-uploaded">
                                                                <img src="{{ asset('assets/uploads/__routeName__/' . __singleVariable__->image_field) }}" alt="default Image">
                                                            </div>
                                                        </div>
                                                    </div>
