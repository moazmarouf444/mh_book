            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{__('dashboard.Edit Cover')}}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <p> انواع الصور المطلوبه
                                ...
                                jpg ,
                                png)</p>
                            <form  method="POST" action="{{route('admin.cover.update' , ['id' => $cover->id])}}" class="store form-horizontal" novalidate>
                                @csrf
                                @method('PUT')
                                <div class="form-body">
                                    <div class="row">
                                                    ...
                                                    <div class="textCenter">
                                                        <div class="imagesUploadBlock">
                                                            <label class="uploadImg">
                                                                ...
                                                                <input type="file" onchange="previewImag(this,7 ,10 ,1)" accept="image/*" name="image" class="imageUploader">
                                                            </label>
                                                ...
                                                <div class="dropBox">
                                                    <div class="textCenter">
                                                        <div class="imagesUploadBlock">
                                                            <label class="uploadImg">
                                                                <span><i class="feather icon-image"></i></span>
                                                                <input type="file" onchange="previewImag(this,7 ,10 ,2)" accept="image/*" name="back_img" class="imageUploader">
                                                            </label>
                                                            <div class="uploadedBlock">
                                                                <img src="{{$cover->back_img}}">
                                                                <button class="close"><i class="la la-times"></i></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="dropBox">
                                                    <div class="textCenter">
                                                        <div class="imagesUploadBlock">
                                                            <label class="uploadImg">
                                                                <span><i class="feather icon-image"></i></span>
                                                                <input type="file" accept="image/*" onchange="previewImag(this,1 ,10 ,3)" name="edge_img" class="imageUploader">
                                                            </label>
                                                            <div class="uploadedBlock">
                                                                <img src="{{$cover->edge_img}}" />
                                                                <button class="close"><i class="la la-times"></i></button>
                                                            </div>
                                                        </div>
                                                    </div>
...
{{--                                        </div>--}}
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="name[ar]" value="{{$cover->getTranslations('name')['ar']}}" class="form-control" placeholder="{{__('dashboard.Write the name in Arabic')}}" required data-validation-required-message="{{__('dashboard.This field is required')}}" >
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="name[en]" value="{{$cover->getTranslations('name')['en']}}" class="form-control" placeholder="{{__('dashboard.Write the name in english')}}" required data-validation-required-message="{{__('dashboard.This field is required')}}" >
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="price" class="form-control" value="{{$cover->price}}" placeholder="{{__('dashboard.Write the price')}}" required data-validation-required-message="{{__('dashboard.This field is required')}}" >
                                                </div>
                                            </div>
                                        </div>
