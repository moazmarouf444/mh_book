                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name_ar" class="form-control" value="{{$role->getTranslations('name')['ar']}}" placeholder="Enter ..." required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>{{awtTrans('الاسم بالانجليزيه')}}</label>
                                            <input type="text" name="name_en" class="form-control" value="{{$role->getTranslations('name')['en']}}" placeholder="Enter ..." required>
                                        </div>
                                    </div>
                                </div>
                            </div>
