                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            <label for="first-name-column">{{__('dashboard.ban_status')}}</label>
                                            <div class="controls">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="first-name-column">{{__('dashboard.activity_status')}}</label>
                                                    <div class="controls">
                                                        <select name="active" class="select2 form-control" required data-validation-required-message="{{awtTrans('هذا الحقل مطلوب')}}" >
                                                            <option value>{{__('dashboard.choose_the_activity_status')}}</option>
                                                            <option {{$row->active == 1 ? 'selected' : ''}} value="1">{{__('dashboard.active')}}</option>
                                                            <option {{$row->active == 0 ? 'selected' : ''}} value="0">{{__('dashboard.inactive')}}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
