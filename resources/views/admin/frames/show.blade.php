            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{__('dashboard.Show Frame')}}</h4>
                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="name_ar" value="{{$frame->getTranslations('name')['ar']}}" class="form-control" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="name_en" value="{{$frame->getTranslations('name')['en']}}" class="form-control" >
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="price" class="form-control" value="{{$frame->price}}" >
                                                    </div>
                                                </div>
                                            </div>
