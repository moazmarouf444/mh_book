                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="message_ar" class="form-control" cols="30" rows="10" required data-validation-required-message="{{awtTrans('هذا الحقل مطلوب')}}"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="message_en" class="form-control" cols="30" rows="10" required data-validation-required-message="{{awtTrans('هذا الحقل مطلوب')}}"></textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="message" class="form-control" cols="30" rows="10" required data-validation-required-message="{{awtTrans('هذا الحقل مطلوب')}}" ></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 col-12">
