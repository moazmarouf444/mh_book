            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{__('dashboard.message_show')}}</h4>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                <label for="first-name-column">{{__('dashboard.phone_number')}}</label>
                                                <div class="controls">
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                <label for="first-name-column">{{__('dashboard.e-mail')}}</label>
                                                <div class="controls">
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                <label for="first-name-column">{{__('dashboard.title')}}</label>
                                                <div class="controls">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                <label for="first-name-column">{{__('dashboard.message')}}</label>
                                                <div class="controls">
                                                    <textarea class="form-control" cols="30" rows="10" disabled>{{$message->message}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 d-flex justify-content-center mt-3">
                                            ...
                                            <a data-toggle="modal" data-target="#replay"  class="btn btn-outline-primary mr-1 mb-1">{{__('dashboard.replay')}}</a>
                                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('admin.complaint.replay' , ['id' => $message->id])}}" method="POST" enctype="multipart/form-data" class="notify-form">
                            @csrf
                            <div class="col-md-12 col-12">
                                <div class="form-group">
