...
class IntroFqsController extends Controller
{
    ...
    public function store(Store $request)
    {
        ...
        Report::addToLog(awtTrans('  اضافه سؤال شائع الخاص بالموقع التعريفي'));
    ...
    public function update(Store $request, $id)
    {
        ...
        Report::addToLog(awtTrans('  تعديل سؤال شائع الخاص بالموقع التعريفي')) ;
        return response()->json(['url' => route('admin.introfqs.index')]);
    }
    ...
    public function show($id)
    {
        $row = IntroFqs::findOrFail($id);
        $categories = IntroFqsCategory::get() ;
        return view('admin.introfqs.show' , ['row' => $row , 'categories' => $categories]);
    }
    ...
    public function destroy($id)
    {
        ...
        Report::addToLog(awtTrans('  حذف سؤال شائع الخاص بالموقع التعريفي')) ;
    ...
    public function destroyAll(Request $request)
    {
        ...
        if (IntroFqs::whereIn('id' , $ids)->delete()) {
            Report::addToLog(awtTrans('  حذف العديد من الاسئلة الشائعة الخاصة بالموقع التعريفي')) ;
