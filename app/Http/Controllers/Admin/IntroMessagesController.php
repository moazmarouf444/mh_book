...
class IntroMessagesController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        Report::addToLog(awtTrans('حذف رسالة خاصه من الرسائل المرسلة للموقع التعريفي'));
    ...
    public function destroyAll(Request $request)
    {
        ...
        if (IntroMessages::whereIn('id' , $ids)->delete()) {
            Report::addToLog(awtTrans('حذف العديد من الرسائل الخاصه من الرسائل المرسلة للموقع التعريفي')) ;
