...
class IntroPartenerController extends Controller
{
    ...
    public function update(Store $request, $id)
    {
        ...
        Report::addToLog(awtTrans('  تعديل شريك  في قسم شركائنا في العمل')) ;
        return response()->json(['url' => route('admin.introparteners.index')]);
    }
    /*************** show *************************************/
    ...
    {
        $row = IntroPartener::findOrFail($id);
        return view('admin.introparteners.show' , ['row' => $row]);
    }
    ...
    public function destroy($id)
    {
        ...
        Report::addToLog(awtTrans('  حذف شريك  من قسم شركائنا في العمل')) ;
    ...
    public function destroyAll(Request $request)
    {
        ...
        if (IntroPartener::whereIn('id' , $ids)->delete()) {
            Report::addToLog(awtTrans('  حذف مجموعه من الشركاء  من قسم شركائنا في العمل')) ;
