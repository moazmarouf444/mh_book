...
class IntroSocialController extends Controller
{
    ...
    public function store(Store $request)
    {
        ...
        Report::addToLog(awtTrans('اضافه وسيلة تواصل لقسم وسائل التواصل الخاصة بالموقع التعريفي')) ;
    ...
    public function update(Store $request, $id)
    {
        ...
        Report::addToLog(awtTrans('تعديل وسيلة تواصل  في قسم وسائل التواصل الخاصة بالموقع التعريفي')) ;
        return response()->json(['url' => route('admin.introsocials.index')]);
    }
    ...
    {
        $row = IntroSocial::findOrFail($id);
        return view('admin.introsocials.show' , ['row' => $row]);
    }
    ...
    public function destroy($id)
    {
        ...
        Report::addToLog(awtTrans('حذف وسيلة تواصل  من قسم وسائل التواصل الخاصة بالموقع التعريفي')) ;
    ...
    public function destroyAll(Request $request)
    {
        ...
        if (IntroSocial::whereIn('id' , $ids)->delete()) {
            Report::addToLog(awtTrans('حذف محموعه من وسائل التواصل  من قسم وسائل التواصل الخاصة بالموقع التعريفي')) ;
