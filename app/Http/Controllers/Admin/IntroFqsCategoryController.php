...
class IntroFqsCategoryController extends Controller
{
    ...
    public function store(Store $request)
    {
        ...
        Report::addToLog(awtTrans('  اضافه قسم للاسئلة الشائعه الخاصه بالموقع التعريفي')) ;
    ...
    public function update(Store $request, $id)
    {
        ...
        Report::addToLog(awtTrans('  تعديل قسم للاسئلة الشائعه الخاصه بالموقع التعريفي')) ;
        return response()->json(['url' => route('admin.introfqscategories.index')]);
    }
    /*************** show *************************************/
    ...
    {
        $row = IntroFqsCategory::findOrFail($id);
        return view('admin.introfqscategories.show' , ['row' => $row]);
    }
    ...
    public function destroy($id)
    {
        ...
        Report::addToLog(awtTrans('  حذف قسم للاسئلة الشائعه الخاصه بالموقع التعريفي')) ;
    ...
    public function destroyAll(Request $request)
    {
        ...
        if (IntroFqsCategory::whereIn('id' , $ids)->delete()) {
            Report::addToLog(awtTrans('  حذف العديد من الاقسام للاسئلة الشائعه الخاصه بالموقع التعريفي')) ;
