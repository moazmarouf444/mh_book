...
class ImageController extends Controller
{
    ...
    public function store(Store $request)
    {
        ...
        Report::addToLog(awtTrans('اضافه بانر_اعلاني'));
    ...
    public function update(Store $request, $id)
    {
        ...
        Report::addToLog(awtTrans('  تعديل بانر_اعلاني')) ;
        return response()->json(['url' => route('admin.images.index')]);
    }
    /*************** show *************************************/
    ...
    {
        $row = Image::findOrFail($id);
        return view('admin.images.show' , ['row' => $row]);
    }
    /***************************  delete  **************************/
    public function destroy($id)
    {
        $row = Image::findOrFail($id)->delete();
        Report::addToLog(awtTrans('حذف بانر_اعلاني'));
    ...
    public function destroyAll(Request $request)
    {
        ...
        if (Image::WhereIn('id',$ids)->delete()) {
            Report::addToLog(awtTrans('حذف العديد من البنرات_الاعلانية'));
