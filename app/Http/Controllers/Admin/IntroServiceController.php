...
class IntroServiceController extends Controller
{
    ...
    public function store(Store $request)
    {
        ...
        Report::addToLog(awtTrans('  اضافه خدمة الي قسم خدماتنا بالموقع التعريفي')) ;
    ...
    public function update(Store $request, $id)
    {
        ...
        Report::addToLog(awtTrans('  تعديل خدمة في قسم خدماتنا بالموقع التعريفي')) ;
        return response()->json(['url' => route('admin.introservices.index')]);
    }
    ...
    {
        $row = IntroService::findOrFail($id);
        return view('admin.introservices.show' , ['row' => $row]);
    }
    ...
    public function destroyAll(Request $request)
    {
        ...
        if (IntroService::whereIn('id' , $ids)->delete()) {
            Report::addToLog(awtTrans('  حذف مجموعه من الخدمات من قسم خدماتنا بالموقع التعريفي'));
