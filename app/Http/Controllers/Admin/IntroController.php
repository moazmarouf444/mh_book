...
class IntroController extends Controller
{
    ...
    public function store(Store $request)
    {
        ...
        Report::addToLog(awtTrans('  اضافه صفحة_تعريفية')) ;
    ...
    public function update(Store $request, $id)
    {
        ...
        Report::addToLog(awtTrans('  تعديل صفحة_تعريفية')) ;
        return response()->json(['url' => route('admin.intros.index')]);
    }
    ...
    {
        $row = Intro::findOrFail($id);
        return view('admin.intros.show' , ['row' => $row]);
    }
    ...
    public function destroy($id)
    {
        ...
        Report::addToLog(awtTrans('  حذف صفحة_تعريفية')) ;
    ...
    public function destroyAll(Request $request)
    {
        ...
        if (Intro::WhereIn('id',$ids)->delete()) {
            Report::addToLog(awtTrans('  حذف العديد من الصفحات_التعريفية')) ;
