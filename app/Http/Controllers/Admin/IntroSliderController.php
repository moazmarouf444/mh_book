...
class IntroSliderController extends Controller
{
    ...
    public function store(Store $request)
    {
        ...
        Report::addToLog(awtTrans('اضافة صورة لقسم البنرات الخاص بالموقع التعريفي')) ;
    ...
    public function update(Store $request, $id)
    {
        ...
        Report::addToLog(awtTrans('تعديل صورة في قسم البنرات الخاص بالموقع التعريفي')) ;
        return response()->json(['url' => route('admin.introsliders.index')]);
    }
    ...
    {
        $row = IntroSlider::findOrFail($id);
        return view('admin.introsliders.show' , ['row' => $row]);
    }
    ...
    public function destroy($id)
    {
        ...
        Report::addToLog(awtTrans('حذف صورة من قسم البنرات الخاص بالموقع التعريفي')) ;
    ...
    public function destroyAll(Request $request)
    {
        ...
        if (IntroSlider::whereIn('id' , $ids)->delete($ids)) {
            Report::addToLog(awtTrans('حذف مجموعه من الصور في قسم البنرات الخاص بالموقع التعريفي'));
