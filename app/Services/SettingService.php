   ...
   public static function appInformations($app_info)
    {
       ...
       $data                        = [
           ...
           'logo'                       =>asset('storage/images/settings/'. $app_info['logo']),
           'fav_icon'                   =>asset('storage/images/settings/'. $app_info['fav_icon']),
           'no_data_icon'               =>$app_info['no_data_icon'],
           'default_user'               =>asset('storage/images/users/'. $app_info['default_user']),
           ...
           'about_image_2'              =>asset('storage/images/settings/'. $app_info['about_image_2']),
           'about_image_1'              =>asset('storage/images/settings/'. $app_info['about_image_1']),
